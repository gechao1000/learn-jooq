...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -860943516;
     ...
     */
    public final TableField<UserRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
    ...
    /**
     * The column <code>test.user.userName</code>. 用户名称
     */
    public final TableField<UserRecord, String> USERNAME = createField("userName", org.jooq.impl.SQLDataType.VARCHAR(64), this, "用户名称");

    /**
     * The column <code>test.user.roleId</code>. 用户角色
     */
    public final TableField<UserRecord, Integer> ROLEID = createField("roleId", org.jooq.impl.SQLDataType.INTEGER, this, "用户角色");

    /**
     * The column <code>test.user.create_date</code>.
     */
